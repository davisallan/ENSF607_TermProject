package PreProjectExercise.Task2;
...
public class InventoryManager {
	...
	public String connectionInfo = "jdbc:mysql://localhost/inventorydb",
				  login          = "davis",
				  password       = "Davisallan123!";
	...
	public void createDB()
	{
		try {
			...
			pStat = jdbc_connection.prepareStatement("CREATE DATABASE " + databaseName);
			pStat.execute();
	...
	public void printTable()
	{
		try {
			...
			pStat = jdbc_connection.prepareStatement(sql);
			ResultSet tools = pStat.executeQuery();
